...
<tr><td class="l">&Iacute;ndice de necesidad</td><td>La f&oacute;rmula con la que este programa reparte la mitad de la partida vecinal. Promedia la parte del d&eacute;ficit del partido que est&aacute; en cada zona en cuatro cosas: NBI, sin cloaca, sin gas de red y hacinamiento. Cuenta hogares, no porcentajes.</td></tr>
<tr><td class="l">TAMAR</td><td>La tasa que los bancos pagan por los plazos fijos grandes. Es la referencia del bono municipal de 2026, que paga TAMAR m&aacute;s 7%: si esa tasa sube, el Municipio paga m&aacute;s intereses sin haber decidido nada.</td></tr>
<tr><td class="l">Copyleft</td><td>Un tipo de licencia de software que obliga a publicar libre todo lo que se construya encima. Por eso este programa no parte del c&oacute;digo de Decidim: lo que San Isidro desarrolle quedar&iacute;a atado a esa obligaci&oacute;n.</td></tr>
