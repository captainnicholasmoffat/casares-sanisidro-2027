...
_IDX = [
 ...
 ("i", "La pregunta", "intro"),
 ("i", "C&oacute;mo est&aacute; construido", "intro"),
 ("i", "Lo que este documento concede antes de criticar", "intro"),
 ("i", "Qu&eacute; promete, y qu&eacute; no", "intro"),
 ("i", "Contra qu&eacute; pide que lo midan", "intro"),
 ("g", "1 &middot; Diagn&oacute;stico", None),
 ("i", "1.1 &nbsp;Dos partidos dentro del mismo partido", "c1a"),
 ("i", "1.2 &nbsp;El municipio invierte m&aacute;s que casi todos. Y no llega.", "c1a2"),
 ("i", "1.3 &nbsp;D&oacute;nde no va el dinero", "c1a2"),
 ("i", "1.4 &nbsp;Por qu&eacute; pasa esto: est&aacute; escrito", "c1b"),
 ("i", "1.5 &nbsp;San Isidro se financia solo. Eso cambia todo.", "c1b"),
 ("i", "1.6 &nbsp;Lo que dice este cap&iacute;tulo, en cinco l&iacute;neas", "c1b"),
 ("g", "2 &middot; La gesti&oacute;n, medida", None),
 ("i", "2.1 &nbsp;C&oacute;mo se escribi&oacute; este cap&iacute;tulo", "c2"),
 ("i", "2.2 &nbsp;Cuatro acusaciones que no se sostienen", "c2"),
 ("i", "2.3 &nbsp;Ejecutar el presupuesto no es prestar el servicio", "c2"),
 ("i", "2.4 &nbsp;Lo que s&iacute; se puede probar: la cobranza se deterior&oacute;", "c2"),
 ("i", "2.5 &nbsp;Lo que se prometi&oacute; publicar y no est&aacute; publicado", "c2b"),
 ("i", "2.6 &nbsp;El hallazgo central: el plan no menciona a la gente", "c2b"),
 ("i", "2.7 &nbsp;Lo que dice este cap&iacute;tulo, en cuatro l&iacute;neas", "c2b"),
 ("g", "3 &middot; Los fondos", None),
 ("i", "3.1 &nbsp;Por qu&eacute; este cap&iacute;tulo existe", "c3a"),
 ("i", "3.2 &nbsp;La trampa contable que casi nos hace decir lo contrario", "c3a"),
 ("i", "3.3 &nbsp;Los cuatro n&uacute;meros que gobiernan el futuro fiscal", "c3a"),
 ("i", "3.4 &nbsp;C&oacute;mo quedan las cuentas si nadie cambia nada", "c3a"),
 ("i", "3.5 &nbsp;Cu&aacute;nto cuesta este programa", "c3b"),
 ("i", "3.6 &nbsp;De d&oacute;nde salen los fondos", "c3b2"),
 ("i", "3.7 &nbsp;Qu&eacute; habr&iacute;a que vigilar", "c3b3"),
 ("i", "3.8 &nbsp;Lo que dice este cap&iacute;tulo, en cuatro l&iacute;neas", "c3b3"),
 ("g", "4 &middot; El mecanismo", None),
 ("i", "4.1 &nbsp;El l&iacute;mite legal: lo que un intendente no puede delegar", "c4a"),
 ("i", "4.2 &nbsp;La deuda que la Provincia tiene con sus municipios", "c4a"),
 ("i", "4.3 &nbsp;Cu&aacute;nto dinero: el n&uacute;mero", "c4a"),
 ("i", "4.4 &nbsp;C&oacute;mo se reparte: por poblaci&oacute;n y por necesidad contada", "c4a2"),
 ("i", "4.5 &nbsp;Qui&eacute;n decide y qui&eacute;n ejecuta: dos capas", "c4b"),
 ("i", "4.6 &nbsp;C&oacute;mo se constituye una comisi&oacute;n, y c&oacute;mo rinde", "c4b"),
 ("i", "4.7 &nbsp;El Concejo Deliberante: diez bloques y ninguna mayor&iacute;a", "c4bb"),
 ("i", "4.8 &nbsp;Por qu&eacute; las dos capas juntas cambian todo", "c4b2"),
 ("i", "4.9 &nbsp;Las otras dos facultades", "c4b2"),
 ("i", "4.10 &nbsp;El primer acto de gobierno: derogar tres art&iacute;culos", "c4b2"),
 ("i", "4.11 &nbsp;Qu&eacute; prometemos y qu&eacute; no", "c4b2"),
 ("i", "4.12 &nbsp;A qui&eacute;n le molesta esto", "c4bc"),
 ("i", "4.13 &nbsp;Lo que dice este cap&iacute;tulo, en cinco l&iacute;neas", "c4bc"),
 ("g", "5 &middot; Qu&eacute; hacemos en cada &aacute;rea", None),
 ("i", "5.1 &nbsp;C&oacute;mo leer este cap&iacute;tulo", "c5a"),
 ("i", "5.2 &nbsp;D&oacute;nde va hoy cada peso", "c5a"),
 ("i", "5.3 &nbsp;Empleo", "c5a2"),
 ("i", "5.4 &nbsp;Vivienda y servicios b&aacute;sicos", "c5a2"),
 ("i", "5.5 &nbsp;Ambiente", "c5b"),
 ("i", "5.6 &nbsp;Salud", "c5bb"),
 ("i", "5.7 &nbsp;Seguridad", "c5bc"),
 ("i", "5.8 &nbsp;Educaci&oacute;n", "c5b2"),
 ("i", "5.9 &nbsp;Digitalizaci&oacute;n: que el tr&aacute;mite tarde diez segundos", "c5b2"),
 ("i", "5.10 &nbsp;Transparencia", "c5b2"),
 ("i", "5.11 &nbsp;Transporte y comercio", "c5b2"),
 ("i", "5.12 &nbsp;Los que tienen que ejecutar todo esto", "c5b3"),
 ("i", "5.13 &nbsp;Lo que este cap&iacute;tulo no promete", "c5b3"),
 ("i", "5.14 &nbsp;Lo que no est&aacute; en este cap&iacute;tulo, y por qu&eacute;", "c5b3"),
 ("i", "5.15 &nbsp;Lo que dice este cap&iacute;tulo, en cinco l&iacute;neas", "c5b3"),
 ("g", "6 &middot; Contra qu&eacute; queremos que nos midan", None),
 ("i", "6.1 &nbsp;Por qu&eacute; este cap&iacute;tulo existe", "c6"),
 ("i", "6.2 &nbsp;Los primeros cien d&iacute;as", "c6"),
 ("i", "6.3 &nbsp;La rampa de la obra vecinal, a&ntilde;o por a&ntilde;o", "c6"),
 ("i", "6.4 &nbsp;Las metas verificables del mandato", "c6b"),
 ("i", "6.5 &nbsp;El calendario del mandato, mes por mes", "c6b"),
 ("i", "6.6 &nbsp;Qu&eacute; no prometemos, y de qui&eacute;n depende", "c6b"),
 ("i", "6.7 &nbsp;Qu&eacute; puede salir mal", "c6c"),
 ("i", "6.8 &nbsp;C&oacute;mo se audita todo esto", "c6c"),
 ("i", "6.9 &nbsp;Lo que dice este cap&iacute;tulo, en cinco l&iacute;neas", "c6c"),
 ("g", "Cierre", None),
