...
<h3>Art&iacute;culo 1 &mdash; Creaci&oacute;n y escala</h3>
<p class="tight">Cr&eacute;ase la Partida de Obra Vecinal, integrada por un porcentaje del cr&eacute;dito
presupuestario del rubro Bienes de Uso del Departamento Ejecutivo, conforme la siguiente escala anual:
...
primera, en proporci&oacute;n directa a la poblaci&oacute;n en viviendas particulares de cada zona
seg&uacute;n el &uacute;ltimo Censo Nacional. La segunda, en proporci&oacute;n al &Iacute;ndice de
Necesidad, definido como el promedio simple de la participaci&oacute;n de cada zona en el total
partidario de: hogares con necesidades b&aacute;sicas insatisfechas; hogares sin desag&uuml;e a red
cloacal; hogares sin gas de red; y hogares en condiciones de hacinamiento. Los cuatro indicadores se
computan en cantidad de hogares y no en porcentajes sobre la zona.</p>
...
Departamento Ejecutivo <b>no podr&aacute; sustituirla por otra</b> ni reimputar su cr&eacute;dito a un
...
<h3>Art&iacute;culo 9 &mdash; Afectaci&oacute;n del recurso e informaci&oacute;n por zona</h3>
...
para vivienda, ni se crea tributo alguno. <b>No se modifican las exenciones de car&aacute;cter
...
teatro independiente, centros culturales y espacios culturales alternativos, en los t&eacute;rminos de su
invitaci&oacute;n a los municipios.</p>

<h3>Art&iacute;culo 2 &mdash; Categor&iacute;a habilitante</h3>
<p class="tight">Incorp&oacute;rase al cuadro de usos la categor&iacute;a prevista en esa ley, con los
topes que ella fija de <b>trescientos (300) asistentes y quinientos (500) metros cuadrados</b>, con
