# -*- coding: utf-8 -*-
from content_a import RH, ex, exhead, fig, duo
...
disponible de que el servicio no se prestaba, y viene de quien gobierna.</p>
...
Mart&iacute;n, en otra causa, estableci&oacute; que la existencia de reclamos previos es un indicio del
deber de prevenci&oacute;n incumplido.</p>
</div>
<div class="callout">
<div class="clabel">La admisi&oacute;n que confirma todo el cap&iacute;tulo 1</div>
<p>Al presentar ese mismo plan, el Municipio explic&oacute; que la divisi&oacute;n de los trabajos
<b>ya no ser&iacute;a la Panamericana, &laquo;que era la referencia habitual para distribuir las tareas
municipales&raquo;</b>, sino la avenida M&aacute;rquez/Rol&oacute;n.</p>
<p>Es decir: <span class="sg">el propio Municipio reconoce por escrito que durante a&ntilde;os
...
<b>Publicar el tiempo de respuesta a los reclamos, desagregado por zona, es una de las cosas que este
...
<div class="callout">
<div class="clabel">Lo que se busc&oacute; y no estaba</div>
<p>El <b>Portal de Datos Abiertos devuelve error 504</b> y no responde. El enlace a las
<b>declaraciones juradas de funcionarios lleva a declaraciones juradas de contribuyentes</b>, que es otra
...
<p>El Municipio publica el tama&ntilde;o de su patrulla y las cifras no coinciden entre s&iacute;. En
marzo de 2025 comunic&oacute; <b>120 m&oacute;viles y 46 motos</b>. En octubre de 2025,
...
Cuentas los haya aprobado. Se publica lo que se mide en los rankings de transparencia fiscal, y lo
...
<tr><td class="l">Seguridad</td><td class="m">Reemplazo del 100% de c&aacute;maras anal&oacute;gicas por HD, anillo digital con 150 c&aacute;maras LPR, +40% de patrulleros y +100% de motos, Ojos en Alerta con 20.000 adherentes</td><td class="m">Mapa de incidentes por zona y patrullaje dirigido a los puntos calientes, que es lo que m&aacute;s baja el delito seg&uacute;n la evidencia; <b>anal&iacute;tica con inteligencia artificial sobre las c&aacute;maras ya instaladas</b>; y una oficina de ciberdelito, que hoy no existe</td></tr>
...
<tr><td class="l">Residuos y ambiente</td><td class="m">Gestionar el 20% de los reciclables, mapear grandes generadores, un punto de acopio en cada localidad</td><td class="m">Licitar la recolecci&oacute;n de residuos &mdash;49.270 millones al a&ntilde;o que nunca se compitieron&mdash; y llevar la funci&oacute;n ambiental de 0,4% a 1,5% del presupuesto</td></tr>
...
<tr class="hi"><td class="l">Salud</td><td class="m"><b>&mdash;</b></td><td class="m">Turno desde el celular y teleconsulta, adhiriendo al sistema provincial que ya funciona en m&aacute;s de sesenta municipios y es gratis; publicar el precio unitario de cada insumo que se compra y el stock de cada hospital; y arreglar las filtraciones que el propio gobierno reconoce</td></tr>
...
""" + exhead("c", "Veinti&uacute;n mil millones de diferencia, seg&uacute;n c&oacute;mo se lea el mismo estado contable") + """
<table>
<colgroup><col><col style="width:190pt"></colgroup>
<tr class="hd"><th>Criterio</th><th class="r">Resultado 2025</th></tr>
<tr><td class="l">Devengado contra devengado</td><td class="n">+14.875 M (super&aacute;vit)</td></tr>
<tr class="hi"><td class="l">Percibido contra devengado (oficial)</td><td class="n"><b>&minus;6.051 M (d&eacute;ficit)</b></td></tr>
</table>
<p class="cap"><b>Fuente:</b> Municipio de San Isidro, Estado de Situaci&oacute;n
Econ&oacute;mico-Financiera 2025, cuenta Ahorro-Inversi&oacute;n-Financiamiento.</p>
...
<tr class="hd"><th>Par&aacute;metro</th><th class="r">Valor</th><th class="r">De d&oacute;nde sale</th></tr>
...
peso m&aacute;s de ingreso.</p>
<p><span class="sg">No mueven el resultado financiero ni una l&iacute;nea.</span> No cambian el
...
agosto se coloc&oacute;: se adjudicaron los 30.000 millones completos, con ofertas por 38.576 millones
&mdash;1,29 veces el monto&mdash; y cien &oacute;rdenes de compra.</p>
<p><b>Las condiciones.</b> Plazo de 36 meses. Tasa variable <b>TAMAR m&aacute;s 7%</b>, que al momento
de la colocaci&oacute;n representaba un <b>30,88% nominal anual</b>. Intereses trimestrales.
Calificaci&oacute;n BBB+(arg) de FIX SCR. Y una garant&iacute;a que importa:
<span class="sg">la cesi&oacute;n de los derechos de cobro de la coparticipaci&oacute;n
provincial</span>.</p>
<p><b>Y ac&aacute; est&aacute; lo que define todo.</b> El capital se devuelve en ocho cuotas trimestrales
del 12,5%, y <b>la primera vence en el mes 15</b>. Contado desde agosto de 2026, eso cae en
...
<tr><td class="l">I trim. 2024</td><td class="n">1.408 M</td><td class="n">2.779 M</td><td class="n">4.187 M</td></tr>
<tr><td class="l">IV trim. 2024</td><td class="n">3.740 M</td><td class="n">14.985 M</td><td class="n">18.725 M</td></tr>
